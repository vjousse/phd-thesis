...
Depuis plus de 10 ans nous assistons à l'explosion du nombre de documents numériques accessibles au public à travers des médias multiples comme les réseaux téléphoniques, le câble, le satellite et surtout le \emph{Web}. Ces documents, en provenance de différents pays, prennent une place croissante dans la vie quotidienne et sont devenus une ressource essentielle. \emph{Youtube} ou les \emph{podcast} qui permettent d'écouter les émissions radios en différé sont des exemples de la diversité croissante des documents multimédias dont nous disposons. Or les méthodes d'accès actuelles restent peu adaptées à la recherche d'information au sein de ces collections de données multimédia.
...
Cette thèse a été menée dans le cadre du projet régional \emph{MILES}. Elle est le fruit d'une collaboration entre le Laboratoire d'Informatique du Maine (LIUM) et le Laboratoire d'Informatique de Nantes Atlantique (LINA).
