...
Des serveurs vocaux aux terminaux mobiles, la RAL est utilisée dans de nombreux domaines. Certains serveurs vocaux peuvent notamment l'utiliser pour détecter le genre du locuteur qui s'exprime. Par exemple, grâce à la plateforme MISTRAL \cite{MeignierMistral}, la société Calistel propose de router les appels d'hommes vers des opératrices féminines et inversement, afin d'obtenir un taux de satisfaction des appels plus important. Mais l'application de la RAL la plus connue est certainement la biométrie. En effet, la RAL va permettre de reconnaître, uniquement grâce à sa voix, un locuteur qui cherche à s'identifier au prêt d'un terminal.
