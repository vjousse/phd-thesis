...
Si les deux n\oe{}uds fils d'un n\oe{}ud $T$ sont appelés $T_{oui}$ et $T_{non}$, et le pourcentage d'exemples de $T$ qui seront attribués aux fils $T_{oui}$ et $T_{non}$, sont notés $p_{oui}$ et $p_{non}$ respectivement, la changement d'impureté $\Delta I$ est défini par la formule \ref{eq:gini}~:
