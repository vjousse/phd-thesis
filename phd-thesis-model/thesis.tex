...
La figure \ref{fig:etapes_transcription_enrichie} décrit les différentes composantes des transcriptions réalisées pour les campagnes de type ESTER. Il est possible de distinguer deux grandes parties. 
...
\subsubsection{Modèles acoustiques}
...
\begin{itemize}
  ...
  \item et l'adaptation par régression linéaire (\emph{Maximum Likelihood Linear Regression : MLLR}).
\end{itemize}

\subsubsection{Modèles de langage}
