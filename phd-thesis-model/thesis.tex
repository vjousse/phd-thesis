...
\cline{2-4}
 ...
 \hline
\textit{Tour précédent} & 18,8 \% (250) & 2,0 \% (31) & 32,6 \% (46)\\
\textit{Tour courant}   & 4,4 \% (206) & 2,0 \% (30) & 33,3 \% (6)\\
\textit{Tour suivant}   & 14,6 \% (1~275) & 16,5 \% (255) & 9,9 \% (131)\\
\textit{Autre}          & 30,4 \% (1~922) & 79,5 \% (1~225) & 57,4 \% (216)\\
\hline
 \hline
\textit{Total}          & 100 \% (3~653) & 100 \% (1~541) & 100 \% (399) \\
\hline
\end{tabular}}
\end{center}
...
\hline
\multicolumn{2}{|c|}{Corpus de Développement} & 86,00\% & 94,07\% & 13,17\% & 13,69\% \\ \hline
\hline
\hline
\multicolumn{2}{|c|}{Corpus de Test} & 77,38\% & 93,28\% & 22,57\% & 25,81\% \\ \hline
\hline
\end{tabular}
\end{center}
...
\hline
\multicolumn{2}{|c|}{Liste par enregistrement} & 21,16~\% & 62,30~\% & 73,55~\% \\ \hline
\hline
\hline
\multicolumn{5}{|c|}{\emph{Corpus de Test}}\\ \hline
\hline
\multicolumn{2}{|c|}{Liste par enregistrement} & 18,83~\% & 60,69~\% & 81,17~\% \\ \hline
\hline
\end{tabular}
\end{center}
...
\hline
\multicolumn{2}{|c|}{Liste globale} & 86,00\% & 94,07\% & 13,17\% & 13,69\% \\ \hline
\multicolumn{2}{|c|}{Liste par enregistrement} & 86,83~\% & 95,66~\% & 12,38~\% & 12,42~\% \\ \hline
\multicolumn{2}{|c|}{Sans liste} & 72,86~\% & 73,39~\% & 29,27~\% & 30,22~\% \\ \hline
\hline
\hline
\multicolumn{6}{|c|}{\emph{Corpus de Test}}\\ \hline
\hline
\multicolumn{2}{|c|}{Liste globale} & 77,38\% & 93,28\% & 22,57\% & 25,81\% \\ \hline
\multicolumn{2}{|c|}{Liste par enregistrement} & 78,03~\% & 95,69~\% & 21,92~\% & 24,19~\% \\ \hline
...
\hline
\textbf{M} & \textbf{M} & 86,83 \% & 95,66 \% & 12,38 \% & 12,42 \% \\ \hline
\textbf{M} & \textbf{A} & 56,44 \% & 78,17 \% & 41,33 \% & - \% \\ \hline
\textbf{A} & \textbf{M} & 42,72 \% & 85,80 \% & 54,88 \% & 61,57 \% \\ \hline
\textbf{A} & \textbf{A} & 21,16 \% & 62,30 \% & 73,55 \% & - \\
\hline
\hline
\multicolumn{6}{|c|}{Corpus de test} \\
\hline
\textbf{M} & \textbf{M} & 78,03 \% & 95,69 \% & 21,92 \% & 24,19 \% \\ \hline
\textbf{M} & \textbf{A} & 34,43 \% & 67,26 \% & 65,57 \% & - \\ \hline
\textbf{A} & \textbf{M} & 22,82 \% & 64,85 \% & 77,18 \% & 80,58 \% \\ \hline
\textbf{A} & \textbf{A} & 18,83 \% & 60,69 \% & 81,17 \% & - \\ 
\hline
\end{tabular}
\end{center}
