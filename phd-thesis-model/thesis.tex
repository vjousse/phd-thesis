...
Sans technique de classification efficace et sans moyen d'accès intuitif, l'information recherchée reste enfouie dans une masse d'information parasite. Cette profusion de documents rend alors l'information difficile à utiliser et à exploiter. Avec l'arrivée d'Internet, les quantités de données disponibles ne cessent de croître. L'indexation manuelle de telles quantités semble utopique. Seuls des moyens automatiques ou faiblement supervisés d'indexation et de recherche permettraient de satisfaire nos besoins. Ces besoins en informations peuvent être synthétisés sous la forme d'une suite d'interrogations à laquelle l'indexation doit répondre : qui a fait quoi ? où et quand ? comment et pourquoi ? 

Les travaux présentés dans cette thèse s'intéressent plus particulièrement aux informations contenues dans les documents audio. Ces informations peuvent être de diverses nature comme la transcription en mots, le thème du document ou encore les intervenants. Ce sont ces différents intervenants que l'identification nommée du locuteur (INL) cherche à identifier. L'INL doit permettre de répondre à cette question : \textbf{qui a parlé et quand ?}

Pour récupérer les informations des locuteurs d'un enregistrement dans de grandes collections de documents, des systèmes entièrement automatiques doivent être utilisés. Certains de ces systèmes exploitent des connaissances a priori sur les locuteurs à identifier mais leur utilisation sur de grandes collections de données est difficile. En effet, obtenir un grand nombre d'informations a priori sur les locuteurs (comme des enregistrements de leur voix) est coûteux en temps. De plus, ces informations peuvent ne pas être disponibles

Un autre type de système permet d'obtenir des informations . Ces systèmes doivent disposer de très peu d'informations a priori sur les documents à traiter. Dans l'idéal, aucune connaissance a priori ne devrait être utilisée, de manière à pouvoir traiter un grand nombre de documents.
