...
Le processus de construction du SCT doit choisir pour chaque question de l'arbre un motif lexical. Pour choisir le meilleur motif, le critère d'\emph{impureté} de Gini $i(T)$ d'un n\oe{}ud $T$ \cite{Breiman84} est utilisé. La meilleure question (ici la meilleure expression régulière) est celle qui présente la plus grande diminution d'\emph{impureté} entre le n\oe{}ud $T$ et ses enfants. Cette diminution d'impureté est appelée $\Delta I$ par la suite. 
