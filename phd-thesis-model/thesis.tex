...
Comme décrit plus haut, cette approche ayant obtenue les meilleurs résultats lors de la dernière campagne d'évaluation Ester 2, c'est tout naturellement qu'elle a été utilisée pour les travaux de cette thèse. Nous discuterons dans X de l'apport de cette méthode pour l'identification nommée du locuteur, par rapport à une approche plus classique à base de règles manuelles prévues être utilisées sur des corpus écrits.
