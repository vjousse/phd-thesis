...
Les travaux présentés dans cette thèse ont permis de mettre en \oe{}uvre un système de ce type. \emph{Milesin} est un système d'INL développé de manière à être le plus autonome possible~: il ne requiert pas d'informations a priori sur les locuteurs d'un document pour les identifier.
