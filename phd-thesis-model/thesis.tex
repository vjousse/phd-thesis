...
La figure \ref{fig:pb_seg_inl} illustre un de ces problèmes. Dans la référence, un seul tour de parole est affecté au locuteur \emph{Maude Bayeu}. Dans l'hypothèse, le système de segmentation a commis une erreur et seule une partie du tour de parole de référence a pu être étiqueté.
