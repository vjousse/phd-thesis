...
L'évaluation a été réalisée sur un corpus de test de 10 heures de données en langue anglaise. Deux types de transcriptions enrichies ont été utilisées : transcriptions manuelles et automatiques. Le taux d'erreur mot pour les transcriptions automatiques est de 18\%, le système utilisé est celui présenté dans \cite{Lamel02lightlysupervised}. 
...
\todo{Présenter les résultats dans un tableau}
