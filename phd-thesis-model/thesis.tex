...
Ce type d'assignation est un problème classique en recherche opérationnelle \cite{Burkard09}. Un des algorithmes les plus utilisés pour résoudre ce problème est \og{} l'algorithme de Kuhn-Munkres \cite{MunkresJames} \fg{}, aussi appelé \og{} algorithme Hongrois \fg{}. Il consiste à trouver le chemin optimal qui maximise (ou minimise) un certain coût. La fonction de coût utilisée est la suivante~:
