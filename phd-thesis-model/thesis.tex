...
Les principales étapes et réflexions qui ont conduit au développement de MILES\_NI, et notamment une analyse des erreurs, sont tout d'abord présentées. Sont ensuite discuté la pertinence des métriques et de l'utilisation de connaissances a priori, avant de finir par l'utilisation de transcriptions automatiques.

\section{Étude du système du LIUM}
...
Cette étude a permis de remettre en question l'arbre de classification ainsi que le processus de décision qui en découle (cf. section \ref{sec:fct_croyances} sur le processus de décision de MILES\_NI). Les travaux intermédiaires menés sur ce processus de décision sont décrits dans le chapitre suivant. Nemesis a par la suite été remplacé par LIA\_NE, la différence de performances de MILES\_NI en utilisant Nemesis ou LIA\_NE est donnée dans le tableau X.
...
Bien que ce ne soit pas la méthode qui obtienne les meilleurs résultats, ce sont les fonctions de croyance qui ont été utilisées pour MILES\_NI. Ce choix est justifié dans la section suivante.
