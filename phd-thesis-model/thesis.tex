...
Les documents disponibles sur le \emph{Web} sont passés en quelques années de la simple page \emph{HTML} ne contenant que du texte, à des pages regroupant divers médias~: l'image, le son ou encore la vidéo. \emph{Youtube} ou les \emph{podcast} qui permettent d'écouter les émissions radios en différé sont des exemples de la diversité croissante des documents mis à notre disposition. Or les méthodes d'accès actuelles restent peu adaptées à la recherche d'information au sein de ces collections de données multimédia.

%Le matériel issu des collections multimédia est riche, composé de différentes sources sonores comme les bruits, la musique, la parole et de différentes sources visuelles telles que les changements de scène, les visages, objets. Utilisées seules ou conjointement, ces données hétérogènes peuvent fournir un grand nombre d'informations utiles pour l'indexation de documents multimédia.

Sans technique de classification efficace et sans moyen d'accès intuitif, l'information recherchée reste enfouie dans une masse d'information parasite. Cette profusion de documents rend alors l'information difficile à utiliser et à exploiter. L'indexation manuelle de telles quantités semble utopique. Seuls des moyens automatiques ou faiblement supervisés d'indexation et de recherche permettraient de satisfaire nos besoins. %Ces besoins en informations peuvent être synthétisés sous la forme d'une suite d'interrogations à laquelle l'indexation doit répondre : qui a fait quoi ? où et quand ? comment et pourquoi ? 

Le matériel issu des collections multimédia est riche, composé de différentes sources sonores comme les bruits, la musique, la parole et de différentes sources visuelles telles que les changements de scène, les visages, objets. Les travaux présentés dans cette thèse utiliseront les informations contenues dans des documents audio en français. Nous nous intéressons à l'identification automatique des locuteurs d'un document en cherchant à nommer chacun d'entre eux par leur prénom et leur nom. Ces travaux sont appelés identification nommée du locuteur (INL). L'INL doit permettre de répondre à cette question : \textbf{qui a parlé et quand ?}

Certains systèmes d'INL exploitent des connaissances a priori sur les locuteurs à identifier~: leur utilisation sur de grandes collections de données est difficile. En effet, obtenir un grand nombre d'informations a priori sur les locuteurs (comme des enregistrements de leur voix) est coûteux en temps. De plus, ces informations peuvent ne pas être disponibles. Dans l'idéal, aucune connaissance a priori ne devrait être utilisée, de manière à pouvoir traiter un grand nombre de documents.

C'est ce type de système qui a été mis en \oe{}uvre dans le travail présenté ici. Le système \emph{Milesin} est un système d'INL qui a été développé de manière à être le plus autonome possible~: il ne requiert pas d'informations a priori sur les locuteurs d'un document pour les identifier.
...
Dans un premier temps, nous présentons dans ce manuscrit les principales composantes du traitement automatique de la parole. De la reconnaissance de la parole à la détection des entités nommées en passant par la reconnaissance automatique du locuteurs, elles permettent de réaliser des transcriptions dites \og{} enrichies \fg{}. Ces transcriptions seront ensuite exploitées par les systèmes d'INL pour nommer les différents locuteurs d'un document audio.
...
Cette thèse s'inscrit dans le domaine de l'identificaton automatique de locuteurs. Plus particulièrement, les travaux présentés ici s'intéressent à l'identification de locuteurs par leur prénom et leur nom dans des documents audio. Ce processus est appelé identification nommée du locuteur (INL).
...
de retrouver les interventions de locuteurs au sein de grandes collections de documents. Plusieurs approchent ont été étudiées dans la littérature, et notamment une approche utilisant des techniques de suivi du locuteur. Ces techniques nécessitent de connaître les locuteurs à identifier au préalable, de manière à obtenir des échantillons de leurs voix. Ces échantillons seront ensuite utilisés pour apprendre des modèles de voix afin d'identifier les locuteurs dans les enregistrements. Ce type d'approche a un inconvénient majeur~: il faut disposer de données a priori qui sont difficile à obtenir. En s'appuyant sur des techniques de reconnaissance automatique du locuteur (RAL)

En s'appuyant sur des techniques de reconnaissance automatique du locuteur (RAL) et sur la transcription du signal fournie par des systèmes de reconnaissance automatique de la parole (SRAP), l'INL permet d'identifier les locuteurs ainsi que leur différentes interventions au sein d'un document audio. (dire que là c'est du francais et de la radio pour l'instant, et qu'ils doivent s'annoncer).
