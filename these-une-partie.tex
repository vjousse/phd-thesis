...
\section{Reconnaissance automatique la parole}
...
\subsubsection{Commandes vocales}
...
\begin{itemize}
  ...
  \item Aide aux handicapés : de tels systèmes peuvent pallier à un organe défaillant ou peuvent être utilisés dans des systèmes destinés à la rééducation d'enfants sourds
\end{itemize}
...
Il existe des typologies des EN beaucoup plus complètes que celle des campagnes MUC comme celle de Paik et coll. \cite{??} ou de Coates-Stephens. Par exemple, celle de Coates-Stephens \cite{??} définit 8 catégories d'EN :
\begin{itemize}
...
Selon Poibeau \cite{??} et Sekine et Eriguchi \cite{??}, les systèmes de détection des EN peuvent êtres classés selon trois grands types :\\
...
\subsection{Reconnaissance automatique de la parole}
...
\subsubsection{Résultats avec liste de locuteurs globale}
...
\subsubsection{Résultats avec liste de locuteurs par show}
...
\subsubsection{Impact de la prise en compte du genre}
...
\subsubsection{Système ouvert sans liste de locuteurs et de leur genre}
...
\subsubsection{Corpus et données}
...
\subsubsection{Utilisation d'une liste de locuteurs globale et de leur genre}
...
\subsubsection{Utilisation d'une liste de locuteurs par show et de leur genre}
...
\subsubsection{Influence de la prise en compte du genre}
...
\subsubsection{Système ouvert sans liste de locuteurs et sans genre}
