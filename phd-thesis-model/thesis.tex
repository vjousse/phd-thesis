...
À ce problème d'ambiguïté vient s'ajouter les variations que peuvent subir les entités nommées~:les variations graphiques (\emph{Parti Socialiste}, \emph{Parti socialiste}), les sigles, acronymes ou abréviations, (\emph{Société Nationale des Chemins de fer Français} \rightarrow \emph{SNCF}), les métaphores (\emph{l'Everest} \rightarrow \emph{le toit du monde}), etc.

Outre la gestion de ces différents problèmes, les systèmes doivent aussi être capable de découvrir de nouvelles entités nommées qui ne sont pas présentes dans leurs lexiques.
