...
\multicolumn{7}{|c|}{\emph{Corpus de Développement}}\\ \hline
\hline
\multicolumn{2}{|c|}{Liste par enregistrement} & 86,83~\% & 95,86~\% & 12,38~\% & 14,74~\% & 214 \\ \hline
\multicolumn{2}{|c|}{Sans liste} & 87,41~\% & 95,71~\% & 11,67~\% & 13,99~\% & 209 \\ \hline
\hline
\hline
\multicolumn{7}{|c|}{\emph{Corpus de Test}}\\ \hline
\hline
\multicolumn{2}{|c|}{Liste par enregistrement} & 78,03~\% & 95,69~\% & 21,92~\% & 24,39~\% & 93 \\ \hline
\multicolumn{2}{|c|}{Sans liste} & 78,36\% & 97,98\% & 20,60\% & 23,58\% & 81 \\ \hline
\hline
\end{tabular}
\end{center}
\caption{Différence entre les méthodes de combinaison globales sur des transcriptions enrichies manuelles en utilisant une liste de locuteurs}
...
%
%Lors de l'utilisation d'un système d'INL avec une liste de locuteurs connue à l'avance, le genre des locuteurs peut généralement être obtenu de la même manière. C'est pourquoi les résultats présentés dans la section \ref{sec:results_milesni} utilisent cette connaissance a priori.
%
%En revanche, lors de l'utilisation d'un système d'INL sans liste de locuteurs, 
%
%Le tableau \ref{tab:results_liumni_sansgenre} présente les résultat de MILES\_NI sans utiliser le genre des locuteurs sans utiliser l'information sur le genre des locuteurs. La liste des locuteurs d'ESTER 1 (tous corpus confondus) est utilisée, mais sans prendre en compte le genre du locuteur.
%
