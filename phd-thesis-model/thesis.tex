...
Les travaux présentés dans cette thèse utilisent les informations contenues dans les documents audio. Ces informations peuvent être de diverses nature comme la transcription en mots, le thème du document ou encore les intervenants. Ce sont ces différents intervenants que les systèmes d'identification nommée du locuteur (INL) cherchent à identifier. L'INL doit permettre de répondre à cette question : \textbf{qui a parlé et quand ?}

Certains de ces systèmes exploitent des connaissances a priori sur les locuteurs à identifier ce qui rend leur utilisation sur de grandes collections de données difficile. En effet, obtenir un grand nombre d'informations a priori sur les locuteurs (comme des enregistrements de leur voix) est coûteux en temps. De plus, ces informations peuvent ne pas être disponibles. Dans l'idéal, aucune connaissance a priori ne devrait être utilisée, de manière à pouvoir traiter un grand nombre de documents.
