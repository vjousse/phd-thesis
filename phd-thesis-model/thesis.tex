...
Pour récupérer les informations sur les locuteurs d'un enregistrement dans de grandes collections de documents, des systèmes entièrement automatiques doivent être utilisés. Ces systèmes doivent disposer de très peu d'informations a priori sur les documents à traiter. Dans l'idéal, aucune connaissance a priori ne devrait être utilisée, de manière à pouvoir traiter un grand nombre de documents.

C'est ce type de système qui a été mis en \oe{}uvre dans le travail présenté ici. Le système \emph{Milesin} est un système d'INL qui a été développé de manière à être le plus autonome possible~: il ne requiert pas d'information a priori sur les locuteurs d'un document pour les identifier.
