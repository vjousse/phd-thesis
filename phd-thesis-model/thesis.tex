...
Le tableau \ref{tab:results_belief} présente les résultats du système sur les corpus de développement et de test, en utilisant des transcriptions totalement manuelles. Le système de détection d'entités nommées utilisé est LIA\_NE, la liste de locuteurs du corpus d'apprentissage, de développement et de test ESTER 1 est utilisée pour filtrer les décisions (ainsi que le genre des locuteurs associé).
