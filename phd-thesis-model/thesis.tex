...
LIA\_NE utilise tout d'abord un processus génératif grâce à un étiqueteur basé sur des HMM (\emph{Hidden Markov Model}) qui permet d'annoter le document avec les parties du discours et des classes sémantiques (personne, organisation, lieu, produit). Ensuite un processus discriminatif basé sur les CRF \cite{CRFNE} (\emph{Conditional Random Field}) est utilisé pour effectivement récupérer les entités nommées 
