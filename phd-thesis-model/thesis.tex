...
\hline
\multicolumn{2}{|c|}{Liste par enregistrement} & -~\% & -~\% & -~\% \\ \hline
\hline
\end{tabular}
\end{center}
...
Le taux d'erreur (en durée) obtenu est d'environ 65~\%. Lorsque l'on utilise \emph{Milesin} avec des transcriptions entièrement automatiques, les erreurs des différents systèmes se cumulent. Aucune adaptation de \emph{Milesin} pour des transcriptions automatiques n'a été effectuée dans ces expériences.
...
Afin d'étudier l'impact des différentes composantes d'une transcription automatique (segmentation/classification et transcription), le tableau X montre les résultats en ne faisant varier qu'un des deux paramètres à la fois. Cette étude à été menée sur le corpus de développement.
