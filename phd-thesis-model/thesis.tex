...
Pour construire un arbre de classification sémantique, plusieurs éléments sont nécessaires \cite{Breiman84}~: un corpus d'apprentissage annoté, un ensemble de questions, un critère de séparation et une condition d'arrêt. Nous décrivons ces différents éléments ci-dessous.
