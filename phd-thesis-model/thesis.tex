...
En revanche lorsqu'aucune liste de locuteurs n'est utilisée, les performances chutent considérablement. Même si le rappel chute de l'ordre de 15~\%, c'est surtout la précision qui est importante dans les systèmes d'INL. En effet, identifier moins de locuteurs mais de façon précise sera préféré à identifier plus de locuteurs en commettant beaucoup d'erreurs. Dans les résultats présentés dans le tableau \ref{tab:results_listes}, la précision chute de 22~\% pour le corpus de développent et de 31~\% pour le corpus de test.
