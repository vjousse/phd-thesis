...
Obtenir l'identité d'un locuteur a d'abord été réalisé avec des méthodes purement acoustiques. Le suivi de locuteur (décrit dans le chapitre \ref{sec:ral}) peut être étendu à $n$ locuteurs afin d'identifier tous les locuteurs d'un document. Bien qu'utilisées depuis plusieurs années, ces méthodes souffrent de plusieurs inconvénients. 
