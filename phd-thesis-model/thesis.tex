...
La reconnaissance automatique de la parole (RAP) a pour but de transcrire sous forme textuelle un signal audio. Ses applications, multiples, vont de la simple commande vocale (reconnaissance de mots isolés) à la transcription complète d'une émission de radio.

\subsection{Commandes vocales}

Les systèmes à commandes vocales sont des systèmes que l'on trouve abondamment dans les systèmes embarqués. Ils vont permettre une interaction entre l'utilisateur et la machine grâce à des commandes vocales. Ces commandes doivent être de simples mots isolés. Les cas d'utilisation sont nombreux, et il serait impossible de tous les citer, en voici un bref aperçu :
...
\begin{itemize}
  ...
  \item Téléphone portables : beaucoup de téléphones permettent de naviguer dans l'interface grâce à la voix
...
Bien qu'il soit techniquement possible d'avoir un vocabulaire assez important, il est généralement limité à une centaine de mots. En effet, les personnes se servant de ces systèmes ne sont de toute façon pas capable de mémoriser aisément une centaine de commandes. De plus, ces mots doivent être contrastés au niveau phonétique, de manière à réduire les risques d'ambiguïté lors de la reconnaissance.

\subsection{Systèmes de compréhension}

Les systèmes de compréhension vont permettre un dialogue contraint avec une machine. L'utilisateur va devoir prononcer une suite de mots clefs que le système est capable de reconnaître. En plus du système de reconnaissance vocale, un autre dispositif de compréhension des phrases doit être adjoint afin de pouvoir effectuer les actions adéquat. Le vocabulaire est restreint à quelques centaines de mots (comme dans les systèmes à commandes vocales) et la syntaxe est aussi restreinte à celle que le système est capable d'interpréter. 
