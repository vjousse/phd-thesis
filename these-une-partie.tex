...
Mais cette tâche a comme principal problème d'être très dépendante des différentes variations qui peuvent apparaître dans la voix d'un locuteur (comme précisé dans \ref{ssec:ral}). En effet, les systèmes de VAL sont très dépendants des variations entre les échantillons de de voix référence et les échantillons de tests. 
