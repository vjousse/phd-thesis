...
\subsection{Résultats avec liste de locuteurs globale et prise en compte du genre}

\todo{Brief sur les listes de locuteurs, afin de se placer dans la ligne droite des autres travaux, les listes étaient utilisés dans tranter, canseco etc donc on fait pareil, on parlera de leur apport plus loin}

Le tableau \ref{tab:results_belief} présente les résultats du système sur les corpus de développement et de test, en utilisant des transcriptions totalement manuelles. La liste de locuteurs utilisée pour le corpus de développement correspond aux locuteurs du corpus d'apprentissage, de développement et de test de la campagne ESTER 1 (ainsi que le genre associés aux locuteurs). La liste de locuteurs utilisée pour le test est celle du corpus de test EPAC. Les résultats en durée et en nombre de locuteurs sont donnés. 
\begin{table}[h]
\begin{center}
\begin{tabular}{|c|c|c|c|c|c|}
\cline{3-6}
