...
Cette thèse s'inscrit dans le domaine de l'identificaton automatique de locuteurs. Plus particulièrement, les travaux présentés ici s'intéressent à l'identification de locuteurs dans des documents audio par leur prénom et leur nom. Ce processus est appelé identification nommée du locuteur (INL).

L'INL contribue à l'indexation automatique de documents audio en fournissant des informations permettant de retrouver des locuteurs au sein de grandes collections de documents audio. En s'appuyant sur des techniques de reconnaissance automatique du locuteur (RAL)
